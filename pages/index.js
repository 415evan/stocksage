...
export default function Home() {
  ...
  const stockContext = result?.stockData
    ? `Symbol: ${result.stockData.ticker} Price: $${result.stockData.price} RSI: ${result.stockData.rsi} MA20: ${result.stockData.ma20 || "N/A"} Support: $${result.stockData.support} Resistance: $${result.stockData.resistance} Sentiment: ${result.analysis?.sentiment || "N/A"}`
    : null;
