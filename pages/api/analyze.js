...
export default async function handler(req, res) {
  ...
  try {
    ...
    const structureCtx = pa.structure
      ? `Trend: ${pa.structure.trend} (${pa.structure.trendStrength}). SwingH: $${pa.structure.lastSwingHigh || "N/A"}, SwingL: $${pa.structure.lastSwingLow || "N/A"}. ${pa.structure.breakOfStructure ? "BOS: " + truncate(pa.structure.breakOfStructure.note, 80) : ""}`
      : "Insufficient data.";
